"""Run one Development-only Project7 V26 closed-loop event."""
...
def main() -> None:
    ...
    controller, _, sensors, lineage = build_operational_v26_controller(
        ...
        v26_value_checkpoint_path=args.v26_value_checkpoint,
    ...
    if write_audit.get("passed") is not True:
        raise RuntimeError("operational V26 failed target write/readback audit")
    ...
    metadata.update(
        {
            "strategy": "proposed",
            "operational_development_runtime_contract": OPERATIONAL_V26_RUNTIME_CONTRACT,
            ...
            "v26_value_estimand": lineage["v26_value_estimand"],
            "v26_selection_contract": lineage["v26_selection_contract"],
            ...
            "hydraulic_knowledge_role": lineage["hydraulic_knowledge_role"],
            ...
            "v26_value_checkpoint_sha256": _sha(args.v26_value_checkpoint),
            "v26_dataset_manifest_sha256": _sha(args.dataset_manifest),
