...
V127_RANKING_AUDIT_CONTRACT = "PROJECT7_V127_FINAL_SURROGATE_DEVELOPMENT_RANKING_AUDIT_V1"
...
def main() -> None:
    ...
    result = {
        ...
        "trainfit_d2": evaluate_objective_groups_v127(
            ...
            device=device, flood_rate_index=args.flood_rate_index,
        ),
        ...
        "d4_fit": evaluate_objective_groups_v127(
            model, cache=d4_fit, names=fit_d4, normalization=normalization, graph=graph,
            device=device, flood_rate_index=args.flood_rate_index,
        ),
        "d4_audit": evaluate_objective_groups_v127(
            model, cache=d4_audit, names=audit_d4, normalization=normalization, graph=graph,
            device=device, flood_rate_index=args.flood_rate_index,
        ),
        "boundary": {
