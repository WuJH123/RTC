"""Run one Development-only V25R2 closed-loop event with exact policy-return TFV admission."""
...
from rtc.direct_tfv_operational_v25r2_runtime import (
...
def main() -> None:
    ...
    controller, _graph, sensors, lineage = build_operational_v25r2_controller(
        ...
        v25r2_value_checkpoint_path=args.v25r2_value_checkpoint,
    ...
    if write_audit.get("passed") is not True:
        raise RuntimeError("operational V25R2 failed target write/readback audit")
    metadata_path = Path(result.metadata_path)
    metadata = json.loads(metadata_path.read_text(encoding="utf-8"))
    metadata.update(
        {
            "strategy": "proposed",
            "operational_development_runtime_contract": OPERATIONAL_V25R2_RUNTIME_CONTRACT,
            ...
            "v25r2_value_checkpoint_sha256": _sha(args.v25r2_value_checkpoint),
