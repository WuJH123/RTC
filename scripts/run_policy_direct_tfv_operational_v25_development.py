"""Run one Development-only V25 closed-loop event with conservative H120 TFV value admission."""
...
from rtc.direct_tfv_operational_v25_runtime import (
...
def main() -> None:
    ...
    controller, _graph, sensors, lineage = build_operational_v25_controller(
        ...
        v25_value_checkpoint_path=args.v25_value_checkpoint,
        matched_truth_bank_manifest_path=args.matched_truth_bank_manifest,
    ...
    if write_audit.get("passed") is not True:
        raise RuntimeError("operational V25 failed target write/readback audit")
    metadata_path = Path(result.metadata_path)
    metadata = json.loads(metadata_path.read_text(encoding="utf-8"))
    metadata.update(
        {
            "strategy": "proposed",
            "operational_development_runtime_contract": OPERATIONAL_V25_RUNTIME_CONTRACT,
            ...
            "tfv_value_estimand": lineage["tfv_value_estimand"],
            "tfv_value_gate_contract": lineage["v25_value_gate_contract"],
            ...
            "v25_value_checkpoint_sha256": _sha(args.v25_value_checkpoint),
            "matched_truth_bank_manifest_sha256": _sha(args.matched_truth_bank_manifest),
