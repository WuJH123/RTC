"""Run one Development-only Project7 V28 q95-matched residual-value closed-loop event."""
...
def main() -> None:
    ...
    controller, _, sensors, lineage = build_operational_v28_controller(
        ...
        v28_residual_checkpoint_path=args.v28_residual_checkpoint,
        dataset_manifest_path=args.dataset_manifest,
        v27_dataset_manifest_path=args.v27_dataset_manifest,
    ...
    if write_audit.get("passed") is not True:
        raise RuntimeError("operational V28 failed target write/readback audit")
    metadata_path = Path(result.metadata_path)
    metadata = json.loads(metadata_path.read_text(encoding="utf-8"))
    metadata.update(
        {
            "strategy": "proposed",
            "operational_development_runtime_contract": V28_OPERATIONAL_RUNTIME_CONTRACT,
            ...
            "v28_q27_frozen": True,
            "v28_residual_model_contract": lineage.get("residual_checkpoint_contract"),
            "v28_residual_checkpoint_sha256": _sha(args.v28_residual_checkpoint),
            "v27_value_checkpoint_sha256": _sha(args.v27_value_checkpoint),
            "v28_selection_contract": lineage.get("selection_contract"),
            "v28_portfolio_contract": lineage.get("v23_portfolio_contract"),
            "v28_tfv_value_estimand": lineage.get("tfv_value_estimand"),
            "v28_event_id_feature": False,
            "v28_auto_rbc_shadow_candidate_only": True,
            "q95_support_execution": True,
            ...
            "dataset_manifest_sha256": _sha(args.dataset_manifest),
            "v27_parent_dataset_manifest_sha256": (
                _sha(args.v27_dataset_manifest)
                if args.v27_dataset_manifest
                else _sha(args.dataset_manifest)
            ),
