...
def main() -> None:
    ...
    if str(lineage.get("rtc_source_tree_sha256", "")).lower() != current_source_sha.lower():
        raise ValueError(
            "first-move admission was generated by a different RTC source tree; regenerate the "
            "first-move panel and calibration before authoritative runtime"
        )
    ...
    metadata.update(
        {
            ...
            "first_move_calibration_rtc_source_tree_sha256": str(lineage["rtc_source_tree_sha256"]),
            "runtime_rtc_source_tree_sha256": current_source_sha,
