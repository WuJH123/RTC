...
DIRECT_TFV_DEVELOPMENT_RUNTIME_CONTRACT = (
    "PROJECT7_DIRECT_TFV_AUTHORITATIVE_10MIN_DEVELOPMENT_RTC_V9_BEHAVIORAL_LINEAGE"
)
...
def main() -> None:
    ...
    if str(lineage.get("first_move_behavioral_source_sha256", "")).lower() != current_behavior.lower():
        raise ValueError(
            "first-move admission was generated by different behavior-defining source; "
            "regenerate the exact panel/calibration before authoritative runtime"
        )
    ...
    metadata.update(
        {
            ...
            "first_move_calibration_behavioral_source_sha256": str(
                lineage["first_move_behavioral_source_sha256"]
            ),
            "runtime_first_move_behavioral_source_sha256": current_behavior,
