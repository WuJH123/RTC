"""Run one Development-only Project7 V29 regime-balanced closed-loop event."""
...
from rtc.direct_tfv_operational_v29_runtime import (
...
def main() -> None:
    ...
    controller, _, sensors, lineage = build_operational_v29_controller(
        ...
        v28r1_residual_checkpoint_path=args.v28r1_residual_checkpoint,
        v29_value_checkpoint_path=args.v29_value_checkpoint,
    ...
    if write_audit.get("passed") is not True:
        raise RuntimeError("operational V29 failed target write/readback audit")
    ...
    metadata.update(
        {
            "strategy": "proposed",
            "operational_development_runtime_contract": V29_OPERATIONAL_RUNTIME_CONTRACT,
            ...
            "v29_regime_value_checkpoint_sha256": _sha(args.v29_value_checkpoint),
            "v28r1_parent_residual_checkpoint_sha256": _sha(args.v28r1_residual_checkpoint),
            ...
            "v27_parent_dataset_manifest_sha256": _sha(args.v27_dataset_manifest),
