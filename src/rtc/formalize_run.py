...
def formalize_run(
    *,
    ...
    if replay.get("rtc_source_tree_sha256") != current_code:
        raise RuntimeError("peak replay was not generated by the current RTC source tree")
    payload: dict[str, object] = {
        "contract": "FORMAL_CLOSED_LOOP_RUN_MANIFEST_V4_CODE_BOUND",
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Bind one causal main run to current code and exact routing-step peak replay"
    )
