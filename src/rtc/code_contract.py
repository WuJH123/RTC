...
IMPLEMENTATION_CONTRACT = {
    "release": "WUHAN_RTC_V066_EVENT_PAIRED_READINESS_IMPLEMENTATION_V2",
    "causal_observation": "T0_INCLUDED_ALL_TRAJECTORIES_V2",
    "event_preparation": "DRY_DWF_PREFIX_PLUS_EXPLICIT_RECOVERY_TAIL_V1",
    "hydraulic_initialization": "WARMUP_DISTINCT_FROM_HISTORY_WITH_DEVELOPMENT_SENSITIVITY_V1",
