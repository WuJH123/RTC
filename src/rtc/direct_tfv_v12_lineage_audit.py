...
This module never declares different behavioral fingerprints equivalent. A stale
admission remains fail-closed unless its behavioral fingerprint and frozen artifact
lineages match the current V12 implementation. When provenance is insufficient, the
recovery action is a matched V12 calibration refresh using the existing role-pure V12
calibration rainfall groups, not new rainfall or generic D3.
"""
