...
The authoritative branch outcome remains unchanged.  Only the *model input* is
changed: future realised SWMM rainfall is replaced by a persistence/decay forecast
constructed from rainfall available at the checkpoint.  This removes the oracle
future-rainfall information advantage without regenerating any SWMM branch.
"""
...
def derive_causal_input_normalization_v120(
    ...
    *,
    ...
    """Derive every normalization statistic from TrainFit only.

    State/flow use the checkpoint values exactly as V7 did. Rainfall statistics use
    the causal forecast rather than the future-realised branch forcing.
    """
