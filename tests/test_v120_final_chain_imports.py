...
def test_v120_final_chain_imports() -> None:
    from rtc.formal_final_v120_guard import main as final_main
    from rtc.policy_lock_v120_guard import main as lock_main
    from rtc.production_v120_bound import run_policy_v120_bound_main
    from rtc.promote_v120_guard import main as promote_main
