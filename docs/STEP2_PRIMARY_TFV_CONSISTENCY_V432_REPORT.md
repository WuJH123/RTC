# PROJECT7 STEP2 PRIMARY TFV CONSISTENCY V4.3.2

```json
{
  "contract": "PROJECT7_STEP2_PRIMARY_TFV_CONSISTENCY_V432",
  ...
  "phase_transition": {
    ...
    "audit_path": "E:\\RTC_sewer\\Project7\\study_v069\\step2_primary_tfv_consistency_v432\\STEP2_PHASE_TRANSITION_DRIFT_AUDIT_V432.json",
    "stages": {
      "A0": {
        "metrics": {
          "groups": 6,
  ...
  "best_d2_backbone": {
    ...
    "metric_error": {
      "rank": 3.992894324067464e-07,
      "pairwise": 1.7074192160126955e-07,
      "sign": 3.2938076488520096e-08,
      "top1": 0.0,
      "max_regret_m3": 0.0
    },
    "reproduced": true
    ...
    "variants": {
      "A_global_mean_summed": {
        ...
        "tiny": {
          "metrics": {
            "groups": 1,
            "spread_ratio": 1.6128083285872161,
            "rank": 0.8333333333333335,
          ...
          "profile": {
            "forward_seconds": 1.152228100108914,
            "backward_seconds": 0.8553356999764219,
            "optimizer_seconds": 0.03940029989462346,
            "wall_time_seconds": 3.163913499971386
          }
        },
        "d3": {
          "groups": 6,
        ...
        "direct_trajectory": {
          "direct": {
            "groups": 6,
            "spread_ratio": 0.6124728448274511,
            "rank": 0.43253968253968256,
            "pairwise": 0.630952380952381,
            "sign": 0.7708333333333334,
            "top1": 1,
          ...
          "trajectory": {
            "groups": 6,
            "spread_ratio": 0.41386318039356174,
            "rank": 0.2896825396825397,
            "pairwise": 0.6130952380952381,
            "sign": 0.8125,
            "top1": 2,
            "mean_regret_m3": 65968.70833333333,
            "max_regret_m3": 162405.75
          },
          "direct_mae_m3": 97664.56514485677,
          "trajectory_mae_m3": 90512.35766601562,
          "direct_trajectory_discrepancy_mae_m3": 22891.468383789062,
          "direct_response_ratio": 0.5186836448484049,
          "trajectory_response_ratio": 0.4929563792128731,
          "truth_abs_mean_m3": 115095.671875
        },
        "d2_prediction_invariance": {
          "D2::T100_D180_chicago::T100_D180_chicago::T100_D180_chicago:t12300": {
            "delta_states": 0.0,
        ...
        "micro": {
          "profile": {
            "forward_seconds": 4.991755899740383,
            "backward_seconds": 3.25188239995623,
            "optimizer_seconds": 0.14156230003573,
            "wall_time_seconds": 12.643234800023492
          }
        }
      },
      "B_nodewise_summed": {
        "name": "B_nodewise_summed",
        "nodewise_tfv": true,
        "gradient_surgery": false,
        "d2_before_d3": {
          "groups": 6,
        ...
        "tiny": {
          ...
          "profile": {
            "forward_seconds": 1.4077841999824159,
            "backward_seconds": 0.6904894998879172,
            "optimizer_seconds": 0.043791000032797456,
            "wall_time_seconds": 3.4363117999746464
          }
        }
      },
      "C_global_mean_surgery": {
        "name": "C_global_mean_surgery",
        "nodewise_tfv": false,
        ...
        "tiny": {
          "metrics": {
            "groups": 1,
            "spread_ratio": 1.9185638541017058,
            "rank": 0.7857142857142858,
            "pairwise": 0.8214285714285714,
            "sign": 0.875,
            "top1": 1,
            "mean_regret_m3": 0.0,
            "max_regret_m3": 0.0
          ...
          "profile": {
            "forward_seconds": 0.8741558000328951,
            "backward_seconds": 3.7492461999645457,
            "optimizer_seconds": 0.029170599940698594,
            "wall_time_seconds": 5.440998799982481
          }
        },
        "d3": {
          "groups": 6,
        ...
        "direct_trajectory": {
          ...
          "trajectory": {
            "groups": 6,
            "spread_ratio": 0.4239957384507001,
            "rank": 0.26587301587301587,
            "pairwise": 0.6071428571428571,
            "sign": 0.8125,
            "top1": 1,
            "mean_regret_m3": 127987.875,
            "max_regret_m3": 372115.0
          },
          "direct_mae_m3": 97650.80293782552,
          "trajectory_mae_m3": 90691.39957682292,
          "direct_trajectory_discrepancy_mae_m3": 22925.847981770832,
          "direct_response_ratio": 0.49392228760185874,
          "trajectory_response_ratio": 0.474343714397825,
          "truth_abs_mean_m3": 115095.671875
        },
        "d2_prediction_invariance": {
          "D2::T100_D180_chicago::T100_D180_chicago::T100_D180_chicago:t12300": {
        ...
        "micro": {
          "profile": {
            "forward_seconds": 5.0443277001031674,
            "backward_seconds": 19.442919299995992,
            "optimizer_seconds": 0.15189170005032793,
            "wall_time_seconds": 28.727527700015344
          }
        }
      },
      "D_nodewise_surgery": {
        "name": "D_nodewise_surgery",
        "nodewise_tfv": true,
        "gradient_surgery": true,
        "d2_before_d3": {
          "groups": 6,
        ...
        "tiny": {
          ...
          "profile": {
            "forward_seconds": 1.0555424999329261,
            "backward_seconds": 4.367629400047008,
            "optimizer_seconds": 0.03169399994658306,
            "wall_time_seconds": 6.505061200005002
          }
        }
      }
    },
    "best_variant": "A_global_mean_summed"
  },
  "compare": {
    "OLD_V4.2": {
      "D2": {
  ...
  "mechanism_interpretation": {
    "phase_drift_root_cause": true,
    "gradient_conflict_causal_contribution": "SUPPORTED",
    "mean_pooling_compression_contribution": "AUDITED",
    "nodewise_additive_aggregation": "HARMFUL_OR_NOT_FIT",
